...
![Tableau](https://img.shields.io/badge/Tableau-Proficient-informational?logo=tableau)&nbsp;
...
## How I Work
- **Business‑first:** start from decisions and KPIs, not tables.  
- **Explainability:** clear SQL, documented DAX, readable notebooks, and concise write‑ups.  
- **Operational rigor:** versioned artifacts, reproducible pipelines, definitions glossary.
